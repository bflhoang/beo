        ...
        <Loading isPending={isPendingUpdate || isPendingUpdated}>
          ...
          >
            ...
            <Form.Item
              ...
              name="countInStock"
              rules={[{ required: true, message: 'Vui lòng nhập số lượng sản phẩm trong Kho!' }]}
            >
            ...
            <Form.Item
              label="Miêu tả"
              name="description"
              rules={[{ required: true, message: 'Vui lòng nhập miêu tả của bạn!' }]}
            >
            ...
            <Form.Item
              label="Hình ảnh"
              name="image"
              rules={[{ required: true, message: 'Vui lòng nhập ảnh của sản phẩm!' }]}
            >
            ...
            <Form.Item name="submitButton" wrapperCol={{ offset: 20, span: 16 }}>
              <Button type="primary" htmlType="submit">
                Xác nhận
              </Button>
            </Form.Item>
